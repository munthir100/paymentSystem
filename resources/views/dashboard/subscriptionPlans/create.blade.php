...
@section('title')
@include("dashboard.layouts.shared.includes.title-meta", ["title" => __("Create Subscription Plan")])
@endsection

@section('page-title')
@include("dashboard.layouts.shared.includes.page-title", ["pagetitle" => __("Create Subscription Plan"), "title" => __("Create New Plan")])
@endsection
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __("Create New Plan") }}</h4>
            </div><!-- end card header -->
                ...
                <form id="subscriptionPlanForm" action="{{ route('dashboard.subscriptionPlans.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 col-12">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="{{ __("Enter plan name") }}" value="{{ old('name') }}" required>
                            @error('name')
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" placeholder="{{ __("Enter plan description") }}" required>{{ old('description') }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 col-12">
                            ...
                            <input type="text" class="form-control @error('association_name') is-invalid @enderror" id="association_name" name="association_name" placeholder="{{ __("Enter association name") }}" value="{{ old('association_name') }}" required>
