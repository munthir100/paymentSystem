            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="#"><i class="ri-briefcase-line text-muted fs-16 align-middle me-1"></i> <span class="align-middle">{{ __('Offices') }}</span></a>
                        <a class="dropdown-item" href="#"><i class="ri-user-2-line text-muted fs-16 align-middle me-1"></i> <span class="align-middle">{{ __('Workers') }}</span></a>
                        <a class="dropdown-item" href="#"><i class="ri-user-line text-muted fs-16 align-middle me-1"></i> <span class="align-middle">{{ __('Customers') }}</span></a>
                        ...
                        <a class="dropdown-item" href="#"><i class="ri-file-list-3-line text-muted fs-16 align-middle me-1"></i> <span class="align-middle">{{ __('Accounting Reports') }}</span></a>
...
<form action="{{ route('dashboard.logout') }}" id="logoutForm" method="post" class="hidden">
    @csrf
</form>
<script>
    function logout() {
